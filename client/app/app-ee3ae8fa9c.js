...
angular.module("sorentinoApp").run(["$templateCache", function($templateCache) {$templateCache.put("app/admin/_sidebar.html","<div class=\"sidebar\"><a href=\"/admin\">All Products</a><a href=\"/admin/create-edit-product\">Create New</a><a href=\"/\">Back To Home</a></div>");
  ...
  $templateCache.put("components/navbar/navbar.html","<div class=\"nav-bar__first-line\"><div class=\"nav-bar__first-line__logo\"><h2 class=\"nav-bar__first-line__logo__name\">Sorentino</h2><div class=\"nav-bar__first-line__logo__menu nav-bar__first-line__logo__menu--left\"><ul><li ng-repeat=\"item in nav.menu.left track by $index\"><a href=\"{{item.link}}\"><span ng-class=\"{\'nav-bar--active\': isActive(item.name)}\">{{item.name}}</span></a><div ng-class=\"{\'nav-bar__sub--show\': item.items &amp;&amp; item.items.length &gt; 0}\" class=\"nav-bar__sub\"><ul ng-if=\"item.items &amp;&amp; item.items.length &gt; 0\"><li ng-repeat=\"subItem in item.items track by $index\"><a href=\"/collection/{{subItem.id}}\"><span>{{subItem.name}}</span></a></li></ul></div></li></ul></div><div class=\"nav-bar__first-line__logo__menu nav-bar__first-line__logo__menu--right\"><ul><li ng-repeat=\"item in nav.menu.right track by $index\"><a href=\"{{item.link}}\"><span ng-class=\"{\'nav-bar--active\': isActive(item.name)}\">{{item.name}}</span></a><div ng-class=\"{\'nav-bar__sub--show\': item.items &amp;&amp; item.items.length &gt; 0}\" class=\"nav-bar__sub\"><ul ng-if=\"item.items &amp;&amp; item.items.length &gt; 0\"><li ng-repeat=\"subItem in item.items track by $index\"><a href=\"/collection/{{subItem.id}}\"><span>{{subItem.name}}</span></a></li></ul></div></li></ul></div></div><h2 class=\"nav-bar__first-line__right-logo\">Sorentino</h2></div><div class=\"nav-bar__second-line\"><ul><li ng-repeat=\"item in nav.menu.left.concat(nav.menu.right) track by $index\"><a href=\"{{item.link}}\"><span ng-class=\"{\'nav-bar--active\': isActive(item.name)}\">{{item.name}}</span></a><div ng-class=\"{\'nav-bar__sub--show\': item.items &amp;&amp; item.items.length &gt; 0}\" class=\"nav-bar__sub\"><ul ng-if=\"item.items &amp;&amp; item.items.length &gt; 0\"><li ng-repeat=\"subItem in item.items track by $index\"><a href=\"/collection/{{subItem.id}}\"><span>{{subItem.name}}</span></a></li></ul></div></li></ul></div>");
