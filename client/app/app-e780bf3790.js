...
angular.module('sorentinoApp', ['sorentinoApp.auth', 'sorentinoApp.admin', 'sorentinoApp.constants', 'ngCookies', 'ngResource', 'ngSanitize', 'ui.router', 'validation.match', 'jkuri.gallery', 'ckeditor', 'ngAnimate']).config(["$urlRouterProvider", "$locationProvider", "$stateProvider", function ($urlRouterProvider, $locationProvider, $stateProvider) {
